...
func (z *ZeroLength) GetResistingForce() *mat.VecDense { return mat.NewVecDense(12, nil) }
...
func (z *ZeroLength) Update(_ []float64) error         { return nil }
func (z *ZeroLength) CommitState() error               { return nil }
func (z *ZeroLength) RevertToStart() error             { return nil }
...
func (z *ZeroLength3DOF) GetResistingForce() *mat.VecDense { return mat.NewVecDense(6, nil) }
...
func (z *ZeroLength3DOF) Update(_ []float64) error         { return nil }
func (z *ZeroLength3DOF) CommitState() error               { return nil }
func (z *ZeroLength3DOF) RevertToStart() error             { return nil }
