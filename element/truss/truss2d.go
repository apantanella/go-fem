...
// For a linear 2D bar each node receives half the total weight (ρ·A·L/2·g).
// Only the X and Y components of g are used.
func (t *Truss2D) BodyForceLoad(g [3]float64, rho float64) *mat.VecDense {
	f := mat.NewVecDense(4, nil)
